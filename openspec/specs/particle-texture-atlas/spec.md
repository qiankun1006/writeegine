# particle-texture-atlas Specification

## Purpose
TBD - created by archiving change add-particle-effect-editor. Update Purpose after archive.
## Requirements
### Requirement: 纹理上传和管理

系统 SHALL 提供纹理上传和管理功能。
...
系统 SHALL 提供 TextureAtlas 映射表管理功能。
